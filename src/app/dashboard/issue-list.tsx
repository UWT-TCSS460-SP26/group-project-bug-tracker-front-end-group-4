  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap items-center gap-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="text-sm border border-zinc-300 dark:border-zinc-700 rounded px-2 py-1 bg-white dark:bg-zinc-900 text-zinc-700 dark:text-zinc-300"
          >
      ...
      {loading && issues.length === 0 ? (
        ...
        <div className="text-center py-16 text-zinc-500 dark:text-zinc-400 border border-dashed border-zinc-300 dark:border-zinc-700 rounded-lg">
          No issues found.
        </div>
      ) : (
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900/50">
                <th className="pl-4 py-2.5 text-left text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">
                  Status
                </th>
                ...
                <th className="pr-4 py-2.5 text-right text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">
                  Created
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
              {issues.map((issue) => (
                <tr
                  ...
                  className="bg-white dark:bg-zinc-900 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
                >
                  ...
                  <td className="pr-4 py-3 text-sm text-zinc-400 dark:text-zinc-500 whitespace-nowrap text-right">
      ...
      {showPagination && (
        <div className="flex items-center justify-between mt-4 text-sm text-zinc-600 dark:text-zinc-400">
          <button
            ...
            className="px-3 py-1 border border-zinc-300 dark:border-zinc-700 rounded hover:bg-zinc-100 dark:hover:bg-zinc-800 disabled:opacity-40 disabled:cursor-not-allowed"
          >
            Previous
          </button>
          <span>
